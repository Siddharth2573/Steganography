...
import com.stegano.strenggeheim.activity.stego.StegoActivity;
import com.stegano.strenggeheim.utils.Constants;
import com.stegano.strenggeheim.utils.StandardMethods;
...
*/
  ...
  public void onCoverSecretImageClick(@NonNull View view) {
...
/*  @Override
  ...
  public String getPath(Uri uri, @NonNull AppCompatActivity activity) {
